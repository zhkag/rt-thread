...
static inline rt_uint32_t read32(rt_size_t addr)
{
    return( *((volatile rt_uint32_t *)(addr)) );
}

static inline void write32(rt_size_t addr, rt_uint32_t value)
{
...
int pl180_init(void)
{
    ...
    virt = (rt_size_t)rt_ioremap((void*)MMC_BASE_ADDR, 0x1000);
